                ...
                <v-list dense>
                    <template v-for="item in items" >
                        <v-list-group v-if="item.children" :key="item.text"
                            v-model="item.model" color="white" prepend-icon="" append-icon="" >
                        ...
                        <v-list-item v-else :key="item.text" :to="item.url" color="white">
                            <v-list-item-action>
                            <v-icon class="white--text">{{ item.icon }}</v-icon>
                            </v-list-item-action>
                            <v-list-item-content>
                    ...
                    <v-list-item @click="toString">
                        <v-list-item-action>
                            <v-switch v-model="theme" color="deep-purple"></v-switch>
                        </v-list-item-action>
                        <v-list-item-content>
                            <v-list-item-title class="white--text">Theme</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                </v-list>
